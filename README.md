# Hotpot
this is hotpot [https://docs.hotpotdao.xyz/] token contract for TON[https://docs.ton.org/]

# TON project
From Starter template for a new TON project - FunC contracts, unit tests, compilation and deployment scripts.
